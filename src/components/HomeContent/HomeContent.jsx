...
const HomeContent = () => {
  return (
    <div className="w-full flex lg:flex-row flex-col-reverse z-2">
      ...
      <div className="w-full lg:w-[90%]">
        <div className="flex flex-col lg:flex-row mt-5">
          <div className="w-full lg:w-1/2">
            <div>
              <h1 className="text-2xl capitalize text-[#212121] font-black">
          ...
          <div className="w-full lg:w-1/2">
            <Image className="mb-4 h-[250px]" src={vegetable} alt="apple" />
          </div>
        </div>
        <div className="mt-5">
